...
public:
    ...
    void set(const std::vector<Color>& pixels, int width, int height) { set(reinterpret_cast<const Color*>(pixels.data()), width, height); }
    void set(const Color* pixels, int width, int height);
